      ...
      <div className="main-container">
        <div className="hero-content">
          ...
          <ul className="features">
            <li>
              <FaCheckCircle className="check-icon" /> Luctus risusd diam eget
            </li>
            <li>
              <FaCheckCircle className="check-icon" /> Donec enim congue magna
            </li>
            <li>
              <FaCheckCircle className="check-icon" /> Blandit sit amet non
              magna
            </li>
          </ul>
