    ...
    return(
        <div className={`${Style.discoverCards}`}>
            <div className="position-relative">
                <Link to='/'><img src={place.image} /></Link>
            ...
            <p style={{font: '500 16px "Poppins"', lineHeight: '24px', marginTop: '20px', height: '20px'}}>{place.name}</p>

            <div className="d-flex" style={{marginTop: '8px', height: '20px'}}>
                <p style={{font: '400 12px "Poppins"', color: '#353945'}}>{place.category}</p>
                <div className="ms-auto d-flex justify-content-center" style={{height: '20px', marginRight: '8px'}}>
                    ...
                    <span style={{font: '600 12px "Poppins"', color: '#777E90'}}>&nbsp;({place.visitors})</span>
                </div>
            </div>

            <div style={{margin: '16px auto', width: '240px'}}><hr /></div>

            <div className="d-flex" style={{height: '20px'}}>
                <p className={Style.opened} style={{color: place.isOpen? '#4AC63F' : '#C63F41'}}>{clock(place.isOpen)}&nbsp;{place.isOpen? 'Opened' : 'Closed'}</p>
                <p className="ms-auto d-flex align-items-center" style={{font: '400 12px "Poppins"', color: '#777E90', marginRight: '8px', height: '20px'}}>{place.openDate}</p>
            </div>
        </div>
    );
}
